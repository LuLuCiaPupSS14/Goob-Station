...
ui-options-function-open-mob-switcher = Open mob switcher
ui-options-function-cycle-mob-next = Cycle mob next
ui-options-function-cycle-mob-prev = Cycle mob previous
